...
class ExpositionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Expositions::create([
            ...
            'img' => "/image/Final_flamingo_the_fucking_final_one14.jpg",
        ]);
        Expositions::create([
        ...
        Expositions::create([
            ...
            'details' => "",
            'img' => "/image/lethal_combination.jpg",
        ]);
        Expositions::create([
