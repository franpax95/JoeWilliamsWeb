...
class ExpositionsTableSeeder extends Seeder
{
    ...
    public function run()
    { 
        $coverCunt = json_encode(array("cover"=> "/image/covercunt.png",
        "img1"=> "/image/cunt13.jpg",
        "img2"=> "/image/cunt15.jpg",
        "img3"=> "/image/cunt18.jpg",
        "img4"=> "/image/cunt20.jpg",
        "img5"=> "/image/cunt27.jpg",
        "img6"=> "/image/cunt32.jpg",
        "img7"=> "/image/cunt35.jpg",
        "img8"=> "/image/cuntcover.jpg"));
        Expositions::create([
        ...
        $finalFlamingo = json_encode(array("cover"=> "/image/Final_flamingo_cover.jpg",
        ...
        $laraLogan = json_encode(array("cover"=> "/image/laracover.png",
        ...
        $synchronicity = json_encode(array("cover"=> "/image/syncvid.png"));
        Expositions::create([
            'title' => "Synchronicity",
        ...
        $humanHerd = json_encode(array("cover"=> "/image/herd_red_2.jpg",
        ...
        $sync = json_encode(array("cover"=> "/image/sync2.jpg"));
        Expositions::create([
            'title' => "Sync",
        ...
        $jam = json_encode(array("cover"=> "/image/jamcover.png"));
        Expositions::create([
            'title' => "JAM",
        ...
        $darkElf = json_encode(array("cover"=> "/image/ira.jpg"));
        Expositions::create([
            'title' => "The Dark Elf",
            'description' => "",
            'type' => "",
        ...
        $lethalCombination = json_encode(array("cover"=> "/image/lethal_combination.jpg"));
        Expositions::create([
        ...
        $readNews = json_encode(array("cover"=> "/image/news_cover.jpg",
        "img1"=> "/image/news.jpg",
        ...
        $velvet = json_encode(array("cover"=> "/image/velvet000682.jpg",
